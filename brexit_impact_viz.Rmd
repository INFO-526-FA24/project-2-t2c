---
title: 'Brexit Blues Analysis'
author: 'Saikumar Bollam, Vamsi krishna'
date: '`r Sys.Date()`'
output: html_document
---

# Introduction
This document analyzes the Brexit referendum data using various visualization and text mining techniques.
...
install.packages("./packages/rgeos.tar.gz", repos = NULL, type = "source")
install.packages("./packages/rgdal.tar.gz", repos = NULL, type = "source")
```
